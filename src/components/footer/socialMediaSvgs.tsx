...
export const Discord = ({ mode = IconMode.FULL }: { mode?: IconMode }) => {
  return (
    <motion.svg
    ...
    >
      <path
        className={"fill-background dark:fill-foreground-dark"}
...
export const LinkedIn = ({ mode = IconMode.FULL }: { mode?: IconMode }) => {
  return (
    <motion.svg
      xmlns="http://www.w3.org/2000/svg"
      className={clsx(mode === IconMode.FULL ? "size-full" : "size-4")}
...
export const Twitter = ({ mode = IconMode.FULL }: { mode?: IconMode }) => {
  return (
    <motion.svg
      xmlns="http://www.w3.org/2000/svg"
      className={clsx(mode === IconMode.FULL ? "size-full" : "size-4")}
...
export const Facebook = ({ mode = IconMode.FULL }: { mode?: IconMode }) => {
  return (
    <motion.svg
      xmlns="http://www.w3.org/2000/svg"
      className={clsx(mode === IconMode.FULL ? "size-full" : "size-4")}
...
export const Github = ({ mode = IconMode.FULL }: { mode?: IconMode }) => {
  return (
    <motion.svg
      xmlns="http://www.w3.org/2000/svg"
      className={clsx(mode === IconMode.FULL ? "size-full" : "size-4")}
